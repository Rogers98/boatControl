...
//    {
//        ui->progressBar->setStyleSheet("QProgressBar { border: 2px solid white;border-radius: 5px;background-color: #02112E;color:white} 
//                                         "QProgressBar { border: 2px solid white;border-radius: 5px;text-align: right;}"
