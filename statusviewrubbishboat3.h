#ifndef STATUSVIEWRUBBISHBOAT3_H
#define STATUSVIEWRUBBISHBOAT3_H
...
namespace Ui {
class StatusViewRubbishBoat3;
}

class StatusViewRubbishBoat3 : public QWidget
{
    Q_OBJECT

public:
    explicit StatusViewRubbishBoat3(QWidget *parent = nullptr);
    ~StatusViewRubbishBoat3();
...
#endif // STATUSVIEWRUBBISHBOAT3_H
