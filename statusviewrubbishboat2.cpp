#include "statusviewrubbishboat2.h"
#include "ui_statusviewrubbishboat2.h"
...
StatusViewRubbishBoat2::StatusViewRubbishBoat2(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::StatusViewRubbishBoat2)
{
    ui->setupUi(this);
...
StatusViewRubbishBoat2::~StatusViewRubbishBoat2()
{
//    recvFile.close();
    delete ui;
}

void StatusViewRubbishBoat2::on_playButton_clicked()
{
...
void StatusViewRubbishBoat2::on_stopButton_clicked()
{
//    _player->stop();
}

void StatusViewRubbishBoat2::on_pushButton_4_clicked()
{
    connect(getData->m_serialPort,SIGNAL(readyRead()),this,SLOT(recvDataFromSerial()));
}

void StatusViewRubbishBoat2::fromJsCallQt()
{
    qDebug() << "qt:来自html的调用";
    this->fromQtCallJs();
...
void StatusViewRubbishBoat2::fromQtCallJs() {
...
void StatusViewRubbishBoat2::keyPressEvent(QKeyEvent *event) {
...
void StatusViewRubbishBoat2::playVideo() {
    //socket配置
        int ServerFd;
        char Buf[BUF_LEN] = {0};
...
void StatusViewRubbishBoat2::LabelDisplayMat(QLabel *label, cv::Mat &mat)
{
    cv::Mat Rgb;
    QImage Img;
...
void StatusViewRubbishBoat2::setRecvDataView(QByteArray data){
...
void StatusViewRubbishBoat2::recvDataFromSerial() {
